...
export default function ClientContactView() {
  ...
  return (
    <div
      className="max-w-screen-xl mt-24 mb-6 sm:mt-14 md:mb-14 sm:mb-[5.5rem] px-6 sm:px-8 lg:px-16 mx-auto"
      id="contact"
    >
                  ...
                  <div key={index} className="p-2 w-full">
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        className="w-full border-red-main border-[2px] bg-[#ffffff] rounded  h-32 text-base outline-none text-[#000000] py-1 px-3 resize-none leading-6"
                      ></textarea>
                    </div>
                  </div>
                ) : (
                  <div className="p-2 w-full" key={index}>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full border-red-main border-[2px] bg-[#ffffff] rounded  text-base outline-none text-[#000000] py-1 px-3 leading-6"
                      />
                    </div>
                  </div>
                )
